...
const userCanAccessFullCourse = (course, user) => {
    ...
    return course.studentsEnrolled?.some((studentId) => sameId(studentId, user.id));
};
...
const buildInstructorSummary = (instructor) => {
    ...
    return {
        ...
        instructorAbout: instructor?.additionalDetails?.about || "Instructor details are not available.",
    };
};
...
exports.getCourseDetails = async (req, res) => {
    try {
        ...
        const courseDetails = await Course.findOne({
            ...
            .populate({
                path: "instructor",
                select: "firstName lastName email image accountType active approved additionalDetails",
                populate: {
